			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<div class="panel container" style="padding:10px;">
                        <form
                            action="Controller/profile.php" method="post" enctype="multipart/form-data">

                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">Name</label>
                                        <input type="text" required=" " class="form-control" placeholder="Enter Name" name="name" require>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required=" " class="form-control" placeholder="Enter Email Address" name="email" require>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" required=" " class="form-control" placeholder="Enter phone number" name="num" require>
                                    </div>
                                </div>
                            </div>
